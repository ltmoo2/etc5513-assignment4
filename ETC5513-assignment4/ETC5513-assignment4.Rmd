...
box <- expectancy_clean %>%
  ...
  # Hi Joyce, you should consider using the following code for prettier color.
  #mutate(Year = as.factor(Year)) %>%
  # Your plot has hard-to-read X axis, therefore I recommed you to do this:
  # 1. Shorten the name: Instead of "Life expectancy at birth (years)", how about Lifespan at birth?
  # 2. Use this code to straighten the line: theme(axis.text.x = element_text(angle=30, hjust=1, vjust=1))
  # Cheers, Thomas. 
